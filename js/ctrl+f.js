...
var find_window_background = "rgba(27,27,27, 0.8)"; // the color of the pop-up window
var find_window_border = "rgba(27,27,27,0.5)"; // the border color of pop-up window
var find_text_color = "white"; // the color of the text in window
var find_title_color = "white"; // color of window title text
var find_window_width = 218; // width of window
var find_window_height = 75; // height of window
...
function create_div(dleft, dtop, dwidth, dheight)
{
	...
	findwindow.style.fontFamily = 'calibri, helvetica, arial, sans-serif';
	findwindow.style.textTransform = 'lowercase';
...
// This part creates the instructions and the "find" button
	...
	+ '<form onsubmit="return false;"><input type="search" class="sch" size="25" maxlength="25" id="fwtext"'
	+ ' onchange="resettext();" placeholder="enter search term...">'
	+ '<input type="button" class="chaise" value=" previous " onclick="findprev();">'
	+ '<input id="btn" class="chaise" type="button" value="  next  " onclick="this.blur(); findit();">' // ver 5.3 - 5/15/2015 - added this.blur();
...
document.write('<input type="button" class="hideme" value="Find on this page..."'
	+ ' onclick="show();">');
